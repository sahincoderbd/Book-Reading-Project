...
const ListedBookItem = ({book}) => {
    ...
    return (
        <div className='p-5 dark:bg-gray-700 flex flex-col lg:flex-row gap-5 rounded-lg border border-gray-300 dark:border-gray-700'>

            <div className='flex-1/10 bg-gray-200 dark:bg-gray-600 rounded-lg p-5 '>
                <img className='w-xl' src={image} alt={name} />
            </div>
            <div className='flex-3/4 py-5 text-left space-y-4'>
             ...
             <p className='ml-3 flex gap-1 flex-nowrap items-center'><SlLocationPin className='text-lg' /> Year of Publishing: {yearOfPublishing}</p>
